        ...
        for rel in range(4):
            ...
            if not os.path.exists(output+target+'_rel{0}'.format(rel)+'.pkl'):
                ...
                for t in tomo_bins:
                    ...
                    f,fb,_   =  g2k_sphere(e1,e2, mask_sims, nside=conf['nside'], lmax=conf['nside']*2 ,nosh=True)
                    fn,fbn,_ =  g2k_sphere(e1n,e2n, mask_sims, nside=conf['nside'], lmax=conf['nside']*2 ,nosh=True)
                    #f[~mask_sims] = 0
                    #fn[~mask_sims] = 0
...
if __name__ == '__main__':
    ...
    output = '//global/cfs/cdirs/des/mgatti/Dirac/output_moments_new_dirac_B/' 
