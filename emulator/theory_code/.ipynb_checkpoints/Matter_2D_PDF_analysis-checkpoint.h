...
void Matter_2D::compute_quantiles(int r_int, string data_file, vector<double> *delta_values, vector<double> *PDF){
  ...
  cout << skewness/normalization << '\n';
	...
	out_file = "quantiles_model_0.209966091999_0.445324094525_"+overloads::to_string(r_int)+".dat";
	...
	out_file = "quantiles_sims_0.209966091999_0.445324094525_"+overloads::to_string(r_int)+".dat";
	remove(out_file.c_str());
	FF = fopen(out_file.c_str(), "w");
	fclose(FF);
	out.open(out_file.c_str());
	...
	out_file = "quantiles_Gaussian_0.209966091999_0.445324094525_"+overloads::to_string(r_int)+".dat";
	remove(out_file.c_str());
	FF = fopen(out_file.c_str(), "w");
	fclose(FF);
	out.open(out_file.c_str());
